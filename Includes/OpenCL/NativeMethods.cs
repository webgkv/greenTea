...
namespace OpenCl {
    ...
    internal class NativeMethods {
        ...
        internal static extern IntPtr clCreateProgramWithSource (
            IntPtr context,
            uint count, [In] string[] strings, [In] IntPtr[] lengths,
            out ErrorCode errcodeRet);

        [DllImport ("OpenCL")]
        internal static extern IntPtr clCreateProgramWithBinary (
            IntPtr context,
            uint numDevices, [In] IntPtr[] deviceList, [In] IntPtr[] lengths, [In] IntPtr[] binaries, [Out] int[] binaryStatus,
            out ErrorCode errcodeRet);
        ...
        internal static extern ErrorCode clEnqueueReadImage (IntPtr commandQueue,
            IntPtr image,
            uint blockingRead, [In][MarshalAs (UnmanagedType.LPArray, SizeConst = 3)] IntPtr[] origin, [In][MarshalAs (UnmanagedType.LPArray, SizeConst = 3)] IntPtr[] region,
            IntPtr rowPitch,
            IntPtr slicePitch,
            IntPtr ptr,
            uint numEventsIntWaitList, [In][MarshalAs (UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 8)] Event[] eventWaitList, [Out] out Event e);

        [DllImport ("OpenCL")]
        internal static extern ErrorCode clEnqueueWriteImage (IntPtr commandQueue,
            IntPtr image,
            uint blockingWrite, [In][MarshalAs (UnmanagedType.LPArray, SizeConst = 3)] IntPtr[] origin, [In][MarshalAs (UnmanagedType.LPArray, SizeConst = 3)] IntPtr[] region,
            IntPtr rowPitch,
            IntPtr slicePitch,
            IntPtr ptr,
            uint numEventsIntWaitList, [In][MarshalAs (UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 8)] Event[] eventWaitList, [Out] out Event e);
        ...
        internal static extern ErrorCode clEnqueueCopyImage (IntPtr commandQueue,
            IntPtr srcImage,
            IntPtr dstImage, [In][MarshalAs (UnmanagedType.LPArray, SizeConst = 3)] IntPtr[] srcOrigin, [In][MarshalAs (UnmanagedType.LPArray, SizeConst = 3)] IntPtr[] dstOrigin, [In][MarshalAs (UnmanagedType.LPArray, SizeConst = 3)] IntPtr[] region,
            uint numEventsInWaitList, [In][MarshalAs (UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 6)] Event[] eventWaitList, [Out] out Event e);

        [DllImport ("OpenCL")]
        internal static extern ErrorCode clEnqueueCopyImageToBuffer (IntPtr commandQueue,
            IntPtr srcImage,
            IntPtr dstBuffer, [In][MarshalAs (UnmanagedType.LPArray, SizeConst = 3)] IntPtr[] srcOrigin, [In][MarshalAs (UnmanagedType.LPArray, SizeConst = 3)] IntPtr[] region,
            IntPtr dstOffset,
            uint numEventsInWaitList, [In][MarshalAs (UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 6)] Event[] eventWaitList, [Out] out Event e);
        ...
        internal static extern ErrorCode clEnqueueCopyBufferToImage (IntPtr commandQueue,
            IntPtr srcBuffer,
            IntPtr dstImage,
            IntPtr srcOffset, [In][MarshalAs (UnmanagedType.LPArray, SizeConst = 3)] IntPtr[] dstOrigin, [In][MarshalAs (UnmanagedType.LPArray, SizeConst = 3)] IntPtr[] region,
            uint numEventsInWaitList, [In][MarshalAs (UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 6)] Event[] eventWaitList, [Out] out Event e);
        ...
        internal static extern ErrorCode clEnqueueUnmapMemObject (IntPtr commandQueue,
            IntPtr memObj,
            IntPtr mappedPtr,
            uint numEventsInWaitList, [In][MarshalAs (UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 3)] Event[] eventWaitList, [Out] out Event e);

        [DllImport ("OpenCL")]
        internal static extern ErrorCode clEnqueueNDRangeKernel (
            IntPtr commandQueue,
            IntPtr kernel,
            uint workDim, [In][MarshalAs (UnmanagedType.LPArray, SizeParamIndex = 2)] IntPtr[] globalWorkOffset, [In][MarshalAs (UnmanagedType.LPArray, SizeParamIndex = 2)] IntPtr[] globalWorkSize, [In][MarshalAs (UnmanagedType.LPArray, SizeParamIndex = 2)] IntPtr[] localWorkSize,
            uint numEventsInWaitList, [In][MarshalAs (UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 6)] Event[] eventWaitList, [Out] out IntPtr e);

        [DllImport ("OpenCL")]
        internal static extern ErrorCode clEnqueueNDRangeKernel (
            IntPtr commandQueue,
            IntPtr kernel,
            uint workDim, [In][MarshalAs (UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt)] uint[] globalWorkOffset, [In][MarshalAs (UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt)] uint[] globalWorkSize, [In][MarshalAs (UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt)] uint[] localWorkSize,
            uint numEventsInWaitList,
            IntPtr[] eventWaitList, [Out] out IntPtr e);

        [DllImport ("OpenCL")]
        internal static extern ErrorCode clEnqueueNDRangeKernel (
            IntPtr commandQueue,
            IntPtr kernel,
            int workDim, [In][MarshalAs (UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt)] int[] globalWorkOffset, [In][MarshalAs (UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt)] int[] globalWorkSize, [In][MarshalAs (UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt)] int[] localWorkSize,
        ...
        internal static extern ErrorCode clEnqueueTask (
            IntPtr commandQueue,
            IntPtr kernel,
            uint numEventsInWaitList, [In][MarshalAs (UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 2)] Event[] eventWaitList, [Out] out Event e);

        [DllImport ("OpenCL")]
        internal static extern ErrorCode clEnqueueMarker (
            IntPtr commandQueue, [Out] out Event e);

        [DllImport ("OpenCL")]
        internal static extern ErrorCode clEnqueueWaitForEvents (
            IntPtr commandQueue,
            uint numEventsInWaitList, [In][MarshalAs (UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 1)] Event[] eventWaitList);
